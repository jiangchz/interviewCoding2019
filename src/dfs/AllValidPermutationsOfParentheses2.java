...
public class AllValidPermutationsOfParentheses2 {
    ...
    // initial thinking for reference --> can be replaced by a one dimensional array
    @Deprecated
    ...
    //can be replaced by a one dimensional array and the mapping information can reply on the index
    @Deprecated
