...
/*
Given a target integer T and an integer leetcode.array A sorted in ascending order,
find the index i in A such that A[i] is closest to T.

Assumptions

There can be duplicate elements in the leetcode.array, and we can return any of the indices with same value.
Examples
