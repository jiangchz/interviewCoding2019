...
/*
Given a leetcode.string, find the longest substring without any repeating characters and return the length of it.
The input leetcode.string is guaranteed to be not null.
