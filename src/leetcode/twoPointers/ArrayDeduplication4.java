...
/*
Given an unsorted integer leetcode.array, remove adjacent duplicate elements repeatedly,
from left to right. For each group of elements with the same value do not keep any of them.

Do this in-place, using the left side of the original leetcode.array. Return the leetcode.array after deduplication.
