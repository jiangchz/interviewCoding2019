...
Given an leetcode.array A of non-negative integers, you are initially positioned at index 0 of the leetcode.array.
 A[i] means the maximum jump distance from that position (you can only jump towards the end of the leetcode.array).
...
{1, 3, 2, 0, 3}, we are able to reach the end of leetcode.array(jump to index 1 then reach the end of the leetcode.array)

{2, 1, 1, 0, 2}, we are not able to reach the end of leetcode.array
