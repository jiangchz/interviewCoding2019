...
680. Split String
中文English
Give a leetcode.string, you can choose to split the leetcode.string after one character or two adjacent characters, and make the leetcode.string to be composed of only one character or two characters. Output all possible results.
