...
/*
Find all pairs of elements in a given leetcode.array that sum to the given target number. Return all the pairs of indices.

Assumptions

The given leetcode.array is not null and has length of at least 2.
