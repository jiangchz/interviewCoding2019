...
/*
Determine if a small leetcode.string is a substring of another large leetcode.string.

Return the index of the first occurrence of the small leetcode.string in the large leetcode.string.

Return -1 if the small leetcode.string is not a substring of the large leetcode.string.

Assumptions

Both large and small are not null
If small is empty leetcode.string, return 0
Examples
